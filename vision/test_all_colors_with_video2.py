    ...
    while (True):
        ...
        for cnr in range(len(contours)):
            ...
            if(area > 1600 and factor >0 and factor <0.88):
                if(mask ==[100,150,0],[140,255,255]):
                    #blue bakje
                    frame = cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 0, 255), 2)
                elif(mask ==[120,100,5],[191,110,158]):
                    #green bakje
                    frame = cv2.rectangle(frame, (x, y), (x + w, y + h), (0, 255, 0), 2)
                elif(mask ==[0,140,44],[100,238,240]):
                    #red bakje
                    frame = cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
                elif(mask ==[50,200,50],[150,20,255]):
                    #grey bakje
                    frame = cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 255, 255), 2)
                elif(mask ==[20,100,100],[30,255,255]):
                    #yellow bakje
